...
def message(**payload):
    ...
    elif text and 'person is' in text.lower():
          new_name = text[14:]
    ...
    # Check for user input and create corresponding lockfile
    elif text and 'calc_faces' in text:
          open('./calc_faces.txt','a').close()
          print("Made calc_faces.txt")
